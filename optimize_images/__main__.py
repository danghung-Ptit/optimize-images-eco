...
def optimize_batch(src_path, watch_dir, recursive, quality, remove_transparency,
            ...
            try:
                for result in executor.map(do_optimization, tasks):
                    ...
                    if result.output_config.show_overall_progress:
                        ...
                        img_status = show_file_status(result, line_width, icons)
                        message_img_status += img_status
    ...
    if found_files:
        ...
        message_report = show_final_report(found_files, optimized_files, total_src_size,
    ...
    return message_img_status, message_report
